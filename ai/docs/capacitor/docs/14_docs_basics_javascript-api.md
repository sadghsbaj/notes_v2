...
## The Global Capacitor object[​](#the-global-capacitor-object "Direct link to The Global Capacitor object")
...
### Capacitor.convertFileSrc[​](#capacitorconvertfilesrc "Direct link to Capacitor.convertFileSrc")
...
### Capacitor.getPlatform[​](#capacitorgetplatform "Direct link to Capacitor.getPlatform")
...
```
if (Capacitor.getPlatform() === 'ios') {  console.log('iOS!');} else if (Capacitor.getPlatform() === 'android') {  console.log('Android!');} else {  console.log('Web!');}
```

### Capacitor.isNativePlatform[​](#capacitorisnativeplatform "Direct link to Capacitor.isNativePlatform")
...
### Capacitor.isPluginAvailable[​](#capacitorispluginavailable "Direct link to Capacitor.isPluginAvailable")
