...
Add the plugin to your Webpack configuration, along with any desired [plugin configuration](/documentation/integrations/webpack/#configuration).
...
`const {   VanillaExtractPlugin } = require('@vanilla-extract/webpack-plugin');  module.exports = {   plugins: [     new VanillaExtractPlugin({       // configuration     })   ] };`
...
[PreviousVite](/documentation/integrations/vite/)
