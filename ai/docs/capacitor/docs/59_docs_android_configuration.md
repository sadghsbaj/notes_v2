...
## Configuring `AndroidManifest.xml`[​](#configuring-androidmanifestxml "Direct link to configuring-androidmanifestxml")
...
## Changing the Package ID[​](#changing-the-package-id "Direct link to Changing the Package ID")
...
## Changing the App Name[​](#changing-the-app-name "Direct link to Changing the App Name")
...
## Deeplinks (aka Android App Links)[​](#deeplinks-aka-android-app-links "Direct link to Deeplinks (aka Android App Links)")
...
Once configured, the [`getLaunchUrl()` method in the App API](/docs/apis/app#getlaunchurl) will provide any URL the app was launched with, and the [`'appUrlOpen'` event](/docs/apis/app#addlistenerpause-) will fire any time the app receives a new App Link deeplink.

## URL Schemes[​](#url-schemes "Direct link to URL Schemes")
...
## Setting Permissions[​](#setting-permissions "Direct link to Setting Permissions")
