...
Remix’s (unstable) Vite compiler works with the [Vite integration](/documentation/integrations/vite). It’s as simple as adding the `@vanilla-extract/vite-plugin` to your Vite config:
...
[PreviousParcel](/documentation/integrations/parcel/)

[NextRollup](/documentation/integrations/rollup/)
