...
## Capacitor Android Requirements[​](#capacitor-android-requirements "Direct link to Capacitor Android Requirements")
...
## Android Target SDK Matrix[​](#android-target-sdk-matrix "Direct link to Android Target SDK Matrix")
...
## Custom Target SDK Versions[​](#custom-target-sdk-versions "Direct link to Custom Target SDK Versions")
