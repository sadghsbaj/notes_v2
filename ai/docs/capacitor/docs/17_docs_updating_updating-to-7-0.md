...
## NodeJS 20+[​](#nodejs-20 "Direct link to NodeJS 20+")
...
## Telemetry is now opt-out[​](#telemetry-is-now-opt-out "Direct link to Telemetry is now opt-out")
...
### add navigation to configChanges[​](#add-navigation-to-configchanges "Direct link to add navigation to configChanges")
...
### Haptics[​](#haptics "Direct link to Haptics")
