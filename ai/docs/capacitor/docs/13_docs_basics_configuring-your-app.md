...
## Capacitor Configuration File[​](#capacitor-configuration-file "Direct link to Capacitor Configuration File")
...
## Native Configuration[​](#native-configuration "Direct link to Native Configuration")
