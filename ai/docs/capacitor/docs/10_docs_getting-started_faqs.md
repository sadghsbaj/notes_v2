...
## What platforms does Capacitor support?[​](#what-platforms-does-capacitor-support "Direct link to What platforms does Capacitor support?")

Capacitor can target virtually any device with our official and community platforms.

### Official Platforms[​](#official-platforms "Direct link to Official Platforms")
...
### Community Platforms[​](#community-platforms "Direct link to Community Platforms")
...
-   Electron
    -   [https://github.com/capacitor-community/electron](https://github.com/capacitor-community/electron)

## Do I need to use Ionic Framework with Capacitor?[​](#do-i-need-to-use-ionic-framework-with-capacitor "Direct link to Do I need to use Ionic Framework with Capacitor?")
...
## Where can I find plugins for my Capacitor project?[​](#where-can-i-find-plugins-for-my-capacitor-project "Direct link to Where can I find plugins for my Capacitor project?")

To find plugins for your project, you should check the following places in this order.

### Capacitor Community GitHub ⚡[​](#capacitor-community-github- "Direct link to Capacitor Community GitHub ⚡")
...
### Awesome Capacitor 😎[​](#awesome-capacitor- "Direct link to Awesome Capacitor 😎")
...
### Project Fugu 🐡[​](#project-fugu- "Direct link to Project Fugu 🐡")
...
### Cordova Plugins 🔌[​](#cordova-plugins- "Direct link to Cordova Plugins 🔌")
...
## Can I build iOS apps without a Mac with Capacitor?[​](#can-i-build-ios-apps-without-a-mac-with-capacitor "Direct link to Can I build iOS apps without a Mac with Capacitor?")
...
## Why do I get a blank screen when running on an Android emulator?[​](#why-do-i-get-a-blank-screen-when-running-on-an-android-emulator "Direct link to Why do I get a blank screen when running on an Android emulator?")
