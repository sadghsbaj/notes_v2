...
## Building your web code[​](#building-your-web-code "Direct link to Building your web code")
...
## Syncing your web code to your Capacitor project[​](#syncing-your-web-code-to-your-capacitor-project "Direct link to Syncing your web code to your Capacitor project")
...
## Testing your Capacitor app[​](#testing-your-capacitor-app "Direct link to Testing your Capacitor app")
...
### Open your Native IDE[​](#open-your-native-ide "Direct link to Open your Native IDE")
...
Opening the native project can give you full control over the native runtime of your application. You can [create plugins](/docs/plugins), [add custom native code](/docs/ios/custom-code), or [compile your application](#compiling-your-native-binary) for releasing.

## Compiling your native binary[​](#compiling-your-native-binary "Direct link to Compiling your native binary")
...
Alternatively, to compile your app in a terminal or in CI environments, you can use the [cap build command](/docs/cli/commands/build) to build the native project, outputting a signed AAB, APK or IPA file ready for distribution to a device or end users.
...
## Updating Capacitor[​](#updating-capacitor "Direct link to Updating Capacitor")
