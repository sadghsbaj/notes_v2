...
## Android Toolbox[​](#android-toolbox "Direct link to Android Toolbox")
...
### Gradle Sync[​](#gradle-sync "Direct link to Gradle Sync")
...
![Android Clean and Build](/docs/assets/images/clean-rebuild-c9262604bc3eaf70413eae3cbe9c210a.png)

### Invalidate Caches/Restart[​](#invalidate-cachesrestart "Direct link to Invalidate Caches/Restart")
...
![Android Invalidate Caches](/docs/assets/images/invalidate-caches-053e48cb4263c0597b12744a01f79f9b.png)

## Error: "package android.support.\* does not exist"[​](#error-package-androidsupport-does-not-exist "Direct link to Error: \"package android.support.* does not exist\"")
...
```
npm install jetifiernpx jetifynpx cap sync android
```

## Error: "Please select Android SDK"[​](#error-please-select-android-sdk "Direct link to Error: \"Please select Android SDK\"")
...
![Sync Gradle](/docs/assets/images/sync-gradle-35d7e33e532f078afdd3ce6aa36efb20.png)

## Error: "APK Can't be installed"[​](#error-apk-cant-be-installed "Direct link to Error: \"APK Can't be installed\"")
...
![Android APK Failed](/docs/assets/images/apk-failed-61aea79e082faa2f7c7d3e8ee27b1eee.png)
...
## Error: "Unable to locate a Java Runtime"[​](#error-unable-to-locate-a-java-runtime "Direct link to Error: \"Unable to locate a Java Runtime\"")
...
![JDK Path in Android Studio](/docs/assets/images/jdk-path-f1b87b49e3e1f58570ae2ae6d93652ae.png)
...
## Recreating your project[​](#recreating-your-project "Direct link to Recreating your project")
...
## Using Proguard[​](#using-proguard "Direct link to Using Proguard")
