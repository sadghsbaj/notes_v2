...
## Android Support[​](#android-support "Direct link to Android Support")
...
## Adding the Android Platform[​](#adding-the-android-platform "Direct link to Adding the Android Platform")
...
## Opening the Android Project[​](#opening-the-android-project "Direct link to Opening the Android Project")
...
### Running with Android Studio[​](#running-with-android-studio "Direct link to Running with Android Studio")
...
![Running App](/docs/assets/images/running-a42ce0daf3b9d2dd5ee6b94d1c378220.png)
...
[Building Native Plugins for Android ›](/docs/plugins/android)
