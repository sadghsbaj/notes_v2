...
## Installing Capacitor in a new Ionic Project[​](#installing-capacitor-in-a-new-ionic-project "Direct link to Installing Capacitor in a new Ionic Project")
...
## Installing Capacitor to an existing Ionic Project[​](#installing-capacitor-to-an-existing-ionic-project "Direct link to Installing Capacitor to an existing Ionic Project")
...
### Install Capacitor Plugin Dependencies[​](#install-capacitor-plugin-dependencies "Direct link to Install Capacitor Plugin Dependencies")
...
## Ionic CLI Capacitor Commands[​](#ionic-cli-capacitor-commands "Direct link to Ionic CLI Capacitor Commands")
