...
## Why Use Ionic Framework with Capacitor?[​](#why-use-ionic-framework-with-capacitor "Direct link to Why Use Ionic Framework with Capacitor?")
...
## Migration Process Overview[​](#migration-process-overview "Direct link to Migration Process Overview")

### Utilize the Ionic VS Code Extension[​](#utilize-the-ionic-vs-code-extension "Direct link to Utilize the Ionic VS Code Extension")
...
### Audit Then Migrate Existing Cordova Plugins[​](#audit-then-migrate-existing-cordova-plugins "Direct link to Audit Then Migrate Existing Cordova Plugins")
...
### Continue to Use Cordova if Needed[​](#continue-to-use-cordova-if-needed "Direct link to Continue to Use Cordova if Needed")
