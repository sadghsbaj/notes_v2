...
## Design Patterns 101[​](#design-patterns-101 "Direct link to Design Patterns 101")
...
## Patterns in the wild[​](#patterns-in-the-wild "Direct link to Patterns in the wild")
...
## What will the screen orientation plugin use?[​](#what-will-the-screen-orientation-plugin-use "Direct link to What will the screen orientation plugin use?")
