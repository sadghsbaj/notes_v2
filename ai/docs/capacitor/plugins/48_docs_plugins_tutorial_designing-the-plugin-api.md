...
## Wait, do you even need a plugin for that?[​](#wait-do-you-even-need-a-plugin-for-that "Direct link to Wait, do you even need a plugin for that?")
...
## Defining the ScreenOrientation API[​](#defining-the-screenorientation-api "Direct link to Defining the ScreenOrientation API")
...
## Registering the ScreenOrientation plugin[​](#registering-the-screenorientation-plugin "Direct link to Registering the ScreenOrientation plugin")
