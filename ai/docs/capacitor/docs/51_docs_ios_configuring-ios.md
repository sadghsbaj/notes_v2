...
## Configuring `Info.plist`[​](#configuring-infoplist "Direct link to configuring-infoplist")
...
![Xcode info editor](/docs/assets/images/xcode-info-editor-4b475489f535a93850f8a18b57cb7d47.png)
...
## Setting Capabilities[​](#setting-capabilities "Direct link to Setting Capabilities")
...
![Xcode Capabilities](/docs/assets/images/xcode-capabilities-a6777da78cd883cfff5e81deed55460a.png)

## Renaming your App[​](#renaming-your-app "Direct link to Renaming your App")
...
![Xcode Target](/docs/assets/images/xcode-target-dab040971aa4c1c12cbcfb96c5fa4a12.png)

Then, open `ios/App/Podfile` and rename the current target at the bottom of the file:

```
-target 'App' do+target 'MyRenamedApp' do   capacitor_pods   # Add your Pods here end
```

Finally, add the `scheme` attribute inside the `ios` object in the [Capacitor configuration file](/docs/config#schema).

## Deeplinks (aka Universal Links)[​](#deeplinks-aka-universal-links "Direct link to Deeplinks (aka Universal Links)")
