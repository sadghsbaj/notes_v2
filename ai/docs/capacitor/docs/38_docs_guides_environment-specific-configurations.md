...
## Prepare a Capacitor App[​](#prepare-a-capacitor-app "Direct link to Prepare a Capacitor App")
...
## Setup a new iOS scheme[​](#setup-a-new-ios-scheme "Direct link to Setup a new iOS scheme")

### Create a new Xcode target[​](#create-a-new-xcode-target "Direct link to Create a new Xcode target")
...
### Rename the new scheme and Plist file[​](#rename-the-new-scheme-and-plist-file "Direct link to Rename the new scheme and Plist file")
...
### Set environment-specific values[​](#set-environment-specific-values "Direct link to Set environment-specific values")
...
### Update the Podfile and sync the App[​](#update-the-podfile-and-sync-the-app "Direct link to Update the Podfile and sync the App")
...
### Add iOS-specific Capacitor configuration[​](#add-ios-specific-capacitor-configuration "Direct link to Add iOS-specific Capacitor configuration")
...
## Setup Android product flavors[​](#setup-android-product-flavors "Direct link to Setup Android product flavors")

### Modify the App's Gradle file[​](#modify-the-apps-gradle-file "Direct link to Modify the App's Gradle file")
...
### Update the Android manifest[​](#update-the-android-manifest "Direct link to Update the Android manifest")
...
### Add Android-specific Capacitor configuration[​](#add-android-specific-capacitor-configuration "Direct link to Add Android-specific Capacitor configuration")
...
## Dynamically build for different environments[​](#dynamically-build-for-different-environments "Direct link to Dynamically build for different environments")

### Export environment-specific Capacitor configuration[​](#export-environment-specific-capacitor-configuration "Direct link to Export environment-specific Capacitor configuration")
...
### Run the App for different environments[​](#run-the-app-for-different-environments "Direct link to Run the App for different environments")
...
## Additional environments and configuration options[​](#additional-environments-and-configuration-options "Direct link to Additional environments and configuration options")
