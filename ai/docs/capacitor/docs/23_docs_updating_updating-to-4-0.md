...
### Remove Unnecessary Code[​](#remove-unnecessary-code "Direct link to Remove Unnecessary Code")
...
### Optional: Remove NSAppTransportSecurity entry from Info.plist[​](#optional-remove-nsapptransportsecurity-entry-from-infoplist "Direct link to Optional: Remove NSAppTransportSecurity entry from Info.plist")
...
### Add `android:exported` tag to your Android Manifest[​](#add-androidexported-tag-to-your-android-manifest "Direct link to add-androidexported-tag-to-your-android-manifest")
...
### Update Gradle Google Services plugin[​](#update-gradle-google-services-plugin "Direct link to Update Gradle Google Services plugin")
...
### Update to Gradle 7[​](#update-to-gradle-7 "Direct link to Update to Gradle 7")
...
### Ensure you are using Java 11[​](#ensure-you-are-using-java-11 "Direct link to Ensure you are using Java 11")
...
![Gradle preferences](/docs/assets/images/android-java-11-3a689fb5f10e972db655982aa0e8c0eb.png)
...
### Change registerPlugin order[​](#change-registerplugin-order "Direct link to Change registerPlugin order")
...
### Optional: Use the new Android 12 Splash Screen API[​](#optional-use-the-new-android-12-splash-screen-api "Direct link to Optional: Use the new Android 12 Splash Screen API")
...
### Optional: Use a DayNight theme[​](#optional-use-a-daynight-theme "Direct link to Optional: Use a DayNight theme")
...
### Optional: Remove `jcenter()` from your Gradle files[​](#optional-remove-jcenter-from-your-gradle-files "Direct link to optional-remove-jcenter-from-your-gradle-files")
...
#### iOS Only[​](#ios-only "Direct link to iOS Only")
...
### Toast[​](#toast "Direct link to Toast")
