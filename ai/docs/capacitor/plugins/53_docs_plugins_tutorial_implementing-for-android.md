...
## Register the plugin with Capacitor[​](#register-the-plugin-with-capacitor "Direct link to Register the plugin with Capacitor")
...
## Getting the current screen orientation[​](#getting-the-current-screen-orientation "Direct link to Getting the current screen orientation")
...
## Listening for screen orientation changes[​](#listening-for-screen-orientation-changes "Direct link to Listening for screen orientation changes")
...
## Locking and unlocking the screen orientation[​](#locking-and-unlocking-the-screen-orientation "Direct link to Locking and unlocking the screen orientation")
