...
## Implementing a New Method[​](#implementing-a-new-method "Direct link to Implementing a New Method")
...
Implement [Android functionality](/docs/plugins/android) in `android/src/main/[nested folders]/EchoPlugin.java`:
...
Implement [iOS functionality](/docs/plugins/ios) in `ios/Sources/EchoPlugin/EchoPlugin.swift`:
...
> Remember to [register plugin methods](/docs/plugins/ios#export-to-capacitor) in your `.swift` file.
...
### Unlinking the Plugin[​](#unlinking-the-plugin "Direct link to Unlinking the Plugin")
...
## Package Scripts[​](#package-scripts "Direct link to Package Scripts")
