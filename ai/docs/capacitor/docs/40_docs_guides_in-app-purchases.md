...
```
npm install cordova-plugin-purchasenpx cap update
```

## Setting up products and consumables[​](#setting-up-products-and-consumables "Direct link to Setting up products and consumables")
