...
## Planning for a Core API[​](#planning-for-a-core-api "Direct link to Planning for a Core API")
...
### Use the new `@CapacitorPlugin` annotation[​](#use-the-new-capacitorplugin-annotation "Direct link to use-the-new-capacitorplugin-annotation")
...
### Android request codes[​](#android-request-codes "Direct link to Android request codes")
...
### Use WebColor.parseColor() over Color.parseColor()[​](#use-webcolorparsecolor-over-colorparsecolor "Direct link to Use WebColor.parseColor() over Color.parseColor()")
...
### Change default compileSdkVersion and targetSdkVersion to 30[​](#change-default-compilesdkversion-and-targetsdkversion-to-30 "Direct link to Change default compileSdkVersion and targetSdkVersion to 30")
...
### Weak References[​](#weak-references "Direct link to Weak References")
...
### Bridge Changes[​](#bridge-changes "Direct link to Bridge Changes")
...
![Xcode autocorrect suggestion](/docs/assets/images/bridge-naming-migration-333ce23cb2ba6157e8d129f2a8b25d7f.png)

### `CAPPluginCall` Parameters[​](#capplugincall-parameters "Direct link to capplugincall-parameters")
...
## Changes to `PluginCall` & `CAPPluginCall`[​](#changes-to-plugincall--capplugincall "Direct link to changes-to-plugincall--capplugincall")

### Use `resolve()` and `reject()`[​](#use-resolve-and-reject "Direct link to use-resolve-and-reject")
...
### `resolve()` without arguments now resolves with `undefined`[​](#resolve-without-arguments-now-resolves-with-undefined "Direct link to resolve-without-arguments-now-resolves-with-undefined")
...
### Saving calls[​](#saving-calls "Direct link to Saving calls")
...
### Registering Plugins[​](#registering-plugins "Direct link to Registering Plugins")
...
### Set TypeScript output to es2017[​](#set-typescript-output-to-es2017 "Direct link to Set TypeScript output to es2017")
...
## Evaluate error handling[​](#evaluate-error-handling "Direct link to Evaluate error handling")
...
## Adopting the new Permissions API[​](#adopting-the-new-permissions-api "Direct link to Adopting the new Permissions API")
