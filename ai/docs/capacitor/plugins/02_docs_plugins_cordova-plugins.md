...
## Installing Cordova Plugins[​](#installing-cordova-plugins "Direct link to Installing Cordova Plugins")
...
## Updating Cordova Plugins[​](#updating-cordova-plugins "Direct link to Updating Cordova Plugins")

Use your regular package manager to update plugins. Then, sync the updated plugin to the native project(s):

```
npm install cordova-plugin-name@versionnpx cap sync
```

## Determining Installed Plugin Version[​](#determining-installed-plugin-version "Direct link to Determining Installed Plugin Version")
...
## Compatibility Issues[​](#compatibility-issues "Direct link to Compatibility Issues")
...
### Variables and Hooks[​](#variables-and-hooks "Direct link to Variables and Hooks")
...
### Known Incompatible Plugins[​](#known-incompatible-plugins "Direct link to Known Incompatible Plugins")
