...
## Update Capacitor dependencies[​](#update-capacitor-dependencies "Direct link to Update Capacitor dependencies")
...
### Update native project to Swift 5[​](#update-native-project-to-swift-5 "Direct link to Update native project to Swift 5")
...
### AndroidX[​](#androidx "Direct link to AndroidX")
...
### Create common variables[​](#create-common-variables "Direct link to Create common variables")
...
### Use common variables[​](#use-common-variables "Direct link to Use common variables")
...
### Android Studio plugin update recommended[​](#android-studio-plugin-update-recommended "Direct link to Android Studio plugin update recommended")
...
### Change `android:configChanges` to avoid app restarts[​](#change-androidconfigchanges-to-avoid-app-restarts "Direct link to change-androidconfigchanges-to-avoid-app-restarts")
...
### Remove `launch_splash.xml`[​](#remove-launch_splashxml "Direct link to remove-launch_splashxml")

The `android/app/src/main/res/drawable/launch_splash.xml` file can be removed because it is no longer used.

### Remove maven repository[​](#remove-maven-repository "Direct link to Remove maven repository")
