...
```
<!-- Geolocation Plugin --><uses-permission android:name="android.permission.ACCESS_COARSE_LOCATION" /><uses-permission android:name="android.permission.ACCESS_FINE_LOCATION" /><uses-feature android:name="android.hardware.location.gps" />
```
...
### getCurrentPosition(...)[​](#getcurrentposition "Direct link to getCurrentPosition(...)")
...
### watchPosition(...)[​](#watchposition "Direct link to watchPosition(...)")
...
#### PositionOptions[​](#positionoptions "Direct link to PositionOptions")
...
#### ClearWatchOptions[​](#clearwatchoptions "Direct link to ClearWatchOptions")
...
```
 ...
 | Permission state for location alias. On Android it requests/checks both ACCESS\_COARSE\_LOCATION and ACCESS\_FINE\_LOCATION permissions. On iOS and web it requests/checks location permission. | 1.0.0 |
| **`coarseLocation`** |
...
#### GeolocationPluginPermissions[​](#geolocationpluginpermissions "Direct link to GeolocationPluginPermissions")
...
#### WatchPositionCallback[​](#watchpositioncallback "Direct link to WatchPositionCallback")
...
#### GeolocationPermissionType[​](#geolocationpermissiontype "Direct link to GeolocationPermissionType")
