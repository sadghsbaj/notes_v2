...
### Avoid Embedding Secrets in Code[​](#avoid-embedding-secrets-in-code "Direct link to Avoid Embedding Secrets in Code")
...
### Storing Encryption Keys, Session Tokens, etc.[​](#storing-encryption-keys-session-tokens-etc "Direct link to Storing Encryption Keys, Session Tokens, etc.")
...
Generally, an app should never send sensitive data through a Custom URL scheme deep link (newer techniques such as Universal Links are more secure as they rely on actual web domain ownership, see the [Deep Links](/docs/guides/deep-links) guide for details).
...
## Web View Security[​](#web-view-security "Direct link to Web View Security")
...
### JavaScript Security Techniques[​](#javascript-security-techniques "Direct link to JavaScript Security Techniques")
