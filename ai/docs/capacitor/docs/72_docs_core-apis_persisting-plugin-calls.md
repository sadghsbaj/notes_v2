...
### Saving a call for a single completion[​](#saving-a-call-for-a-single-completion "Direct link to Saving a call for a single completion")
...
```
func saveCall(_ call: CAPPluginCall)func savedCall(withID: String) -> CAPPluginCall?func releaseCall(_ call: CAPPluginCall)func releaseCall(withID: String)
```

**Android**

```
void saveCall(PluginCall call)PluginCall getSavedCall(String callbackId)void releaseCall(PluginCall call)void releaseCall(String callbackId)
```

* * *

### Saving a call for multiple completions[​](#saving-a-call-for-multiple-completions "Direct link to Saving a call for multiple completions")
